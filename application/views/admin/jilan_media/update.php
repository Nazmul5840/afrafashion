                                            ...
                                            foreach ($secondLevel as $second) {
                                                ...
                                                if (is_array($thirdLevel) && !empty($thirdLevel)) {
                                                    foreach ($thirdLevel as $third) {
                                                        ?>
                                                        <option class="sub_cat_options" style="margin-left: 35px" value="<?php echo $third->id; ?>"<?php echo ($third->id == $allData->category_id) ? 'selected' : ''; ?> >-- <?php echo $third->category_name; ?></option>
                                                    <?php
                                                    }
                                                }
                        ...
                        <div class="col-lg-10">
                            ...
                            <div class="gallery photo_preview">
                                <div class="thumbview">
                                    ...
                                    <?php
                                    if (!empty($allData)) {
                                        $photos = getAllMedia('media', $allData->jilanmedia_id, 'jilanmedia');
                                        ?>
                                        <?php if (!empty($photos)) { ?>
                                                    ...
                                                    <li id="order_<?php echo $photo->id; ?>" style="float:none; display: block; width: 100%;">
                                                        <div style="width:100%; overflow: hidden; background: #fff; padding: 5px;">
                                                            <div class='thumb' style="width:160px; overflow: hidden;float: left; background: #fff; padding: 5px; margin-right: 12px;">
                                                                <img src='<?php echo base_url('assets/media/jilanmedia/thumbs/' . $photo->images); ?>'>

                                                                <a class="delete_info" style="position: absolute;bottom: 6px; left: 5px;" href="<?php echo admin_url('jilanmedia/delete_photo/' . $photo->id . '/' . $photo->typeid); ?>" onclick="return confirm('Are you Sure??\nYou Want to Removed this Photo!');">
                                            ...
                                            <li id="" style="float:none; display: block; width: 100%;">
                                                <div style="width:100%; overflow: hidden; background: #fff; padding: 5px;">
                                                    <div class='thumb' style="width:160px; overflow: hidden;float: left; background: #fff; padding: 5px; margin-right: 12px;">
                                                        ...
                                                        <a class="delete_info" style="position: absolute;bottom: 6px; left: 5px;" href="<?php echo admin_url($this->_module . '/delete_video/' . $allData->jilanmedia_id); ?>" onclick="return confirm('Are you sure?? \n You want to removed this Video!');">
                                                            <span class="btn btn-danger btn-xs" title="Delete this photo"><i class="glyphicon glyphicon-remove"></i></span></a>
                                                    </div><!--thumb-->
                                                </div>
