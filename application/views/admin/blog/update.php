            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="text" name="title" required value="<?php echo $blog->title; ?>" placeholder="Title" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 col-sm-2 control-label">Summary<span class="req"> * </span></label>
                        <div class="col-lg-9">
                            <textarea name="summary" rows="3" required placeholder="Summary" class="form-control"><?php echo $blog->summary; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 col-sm-2 control-label">Description<span class="req"> * </span></label>
                        <div class="col-lg-9">
                            <textarea name="description" required rows="15" placeholder="Description" class="form-control"><?php echo $blog->description; ?></textarea>
                        </div>
                    </div>
                    <div class="form-group">
