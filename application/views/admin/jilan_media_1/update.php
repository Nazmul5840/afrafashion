                            ...
                            <select name="category" class="form-control" >
                                ...
                                if (is_array($result) && !empty($result)) {
                                    ...
                                    foreach ($result as $obj) {
                                        $results = get('jilanmedia_category', array('parent_id' => $obj->id));                                       
                                        ?>
                                        ...
                                        ?> <?php echo ($obj->id == $allData->category_id) ? 'selected' : ''; ?>><?php echo $obj->category_name; ?></option> 
                                                ...
                                                if (is_array($result)) {
                                                    foreach ($result as $obj) {
                                                        ?>
                                                <option class="sub_cat_options" style="margin-left: 25px" value="<?php echo $obj->id; ?>"<?php echo ($obj->id == $allData->category_id) ? 'selected' : ''; ?> ><?php echo $obj->category_name; ?></option> 
                                                <?php
                                            }
                                        }
                                    }
                                                    ...
                                                    <li id="order_<?php echo $photo->id; ?>">
                                                        <div class='thumb'>
                                                            ...
                                                            <div class='infos'>
                                                                ...
                                                                <p class="menu">
                                                                    <a href="<?php echo admin_url('jilanmedia/delete_photo/' . $photo->id . '/' . $photo->typeid); ?>" onclick="return confirm('Are you Sure??\nYou Want to Removed this Photo!');">
