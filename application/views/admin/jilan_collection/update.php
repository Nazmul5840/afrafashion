            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                                                        ...
                                                        foreach ($thirdLevel as $third) {
                                                            ...
                                                            if (is_array($fourthLevel) && !empty($fourthLevel)) {
                                                                foreach ($fourthLevel as $fourth) {
                                                                    ?>
                                                                    <option class="sub_cat_options" style="margin-left: 25px" value="<?php echo $fourth->id; ?>"<?php echo ($fourth->id == $allData->category_id) ? 'selected' : ''; ?> >--- <?php echo $fourth->category_name; ?></option> 
                                                                    <?php
                                                                    ...
                                                                    ?>
                                                                        <option class="sub_cat_options" style="margin-left: 30px" value="<?php echo $fifth->id; ?>"<?php echo ($fifth->id == $allData->category_id) ? 'selected' : ''; ?> >--- <?php echo $fifth->category_name; ?></option>
                                                                    <?php
                                                                        }
                                                                    }
                                                                }
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <input type="number" name="price" min="0" value="<?php echo !empty($allData->price) ? $allData->price : '' ?>" placeholder="Price" class="form-control" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-lg-2 col-sm-2 control-label">Description</label>
                        <div class="col-lg-9">
                            <textarea name="description" rows="10" class="form-control"><?php echo !empty($allData->description) ? $allData->description : '' ?></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <select name="is_popular" class="form-control" required>
                                <option <?php echo  $allData->is_popular=='no' ? 'selected':''; ?> value="no">No</option>
                                <option <?php echo  $allData->is_popular=='yes' ? 'selected':''; ?> value="yes">Yes</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <select name="is_featured" class="form-control" required>
                                <option <?php echo  $allData->is_featured=='no' ? 'selected':''; ?> value="no">No</option>
                                <option <?php echo  $allData->is_featured=='yes' ? 'selected':''; ?> value="yes">Yes</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-9">
                            <select name="is_latest" class="form-control" required>
                                <option <?php echo  $allData->is_latest=='no' ? 'selected':''; ?> value="no">No</option>
                                <option <?php echo  $allData->is_latest=='yes' ? 'selected':''; ?> value="yes">Yes</option>
                            </select>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-10">
                            <input type="file" style="border:0px; height:auto; padding:0; background-color:unset; margin-bottom: 10px" name="cart_photo"  value="" id=""/>
                            ...
                            <div style="width:100%; overflow: hidden; background: #fff; padding: 5px;">
                                <div class='thumb' style="width:250px; overflow: hidden;float: left; background: #fff; padding: 5px; margin-right: 12px;">
                                    <img src='<?php echo base_url('assets/media/jilancollection/cart/' . $allData->cart_photo); ?>'>
                                </div><!--thumb-->
                            </div>
                        </div>
                    </div>
