...
class Profile extends CI_Controller {
    ...
    public $_pageGroup;
    public $module;
    public $_moduleJilanCollectionImagePath;
    public $_leftMenu;
    ...
    function __construct() {
        ...
        $this->_module = "admin/profile";
        $this->_moduleJilanCollectionImagePath = "assets/media/jilancollection/";
    ...
    public function dashboard() {
        ...
        $data['galleryInfo'] = $galleryInfo = $this->global_model->getJilanCollectionContentDashboard(4);
        
        $data['totalActivities'] = $this->global_model->countRow('activities');
        $data['totalEntertainment'] = $this->global_model->countRow('entertainment');
        $data['totalJilanCollection'] = $this->global_model->countRow('jilancollection');
        $data['totalJilanMedia'] = $this->global_model->countRow('jilanmedia');
    ...
    public function view($popup = FALSE) {
        ...
        $this->session->set_userdata('return_url', $this->_module . '/view/' . $this->session->userdata('user_id')); // set the last visit page
        // set the page name
    ...
    public function edit() {
        ...
        $this->session->set_userdata('return_url', $this->_module . '/edit/' . $this->session->userdata('user_id')); // set the last visit page
        // set the page name
    ...
    public function changeUserName() {
        ...
        $this->session->set_userdata('return_url', $this->_module . '/changeUserName/' . $this->session->userdata('user_id')); // set the last visit page
        // set the page name
        $data['pageGroup'] = $this->_pageGroup;
