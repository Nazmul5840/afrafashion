            ...
            foreach ($categories as $cat) {
                ...
                <li>
                        <a href="javascript:void(0)" class="<?php echo $activelink; ?>">
                            <?php echo strtoupper($cat->category_name); /* Men's Wear */
                        ...
                        if (is_array($subCategories) && !empty($subCategories)) {
                            ...
                            foreach ($subCategories as $subCategory) {
                                ...
                                <a href="<?php echo $url; ?>" class="<?php echo is_array($subSubCategories) && !empty($subSubCategories)?'':'' ?> <?php echo $activelink; ?>"><?php echo strtoupper($subCategory->category_name); /* Summer */ ?> </a>
...
//                                                pr($subSubCategory);
                                                ...
                                                <a href="<?php echo $url; ?>" class="<?php echo is_array($subSubSubCategories) && !empty($subSubSubCategories)?'':'' ?>  <?php echo $activelink; ?>"><?php echo strtoupper($subSubCategory->category_name); ?></a>
                                                        ...
                                                        if (is_array($subSubSubCategories) && !empty($subSubSubCategories)) {
                                                            ...
                                                            foreach ($subSubSubCategories as $subSubSubCategory) {
                                                                ...
                                                                ?>
                                                                <li> <a class="<?php echo $activelink; ?>" href="<?php echo!empty($url) ? $url : 'javascript:void(0)'; ?>"><?php echo strtoupper($subSubSubCategory->category_name); ?></a> </li>
                                                            <?php } ?>
