        ...
        <div class="container">
            ...
            <form class="form-signin" name="formSingin" action="" enctype="multipart/form-data" method="post">
                ...
                <div class="login-wrap">
                    ...
                    <input type="text" name="email" id="email" class="form-control" placeholder="Your email ID" value="<?php echo set_value('email'); ?>" required autofocus>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <input type="text" name="email" id="email" placeholder="Your Email ID" autocomplete="off" class="form-control placeholder-no-fix" style="margin-bottom: 5px">
