                        ...
                        <tbody class="">
                            ...
                            if (is_array($result) && !empty($result)) {
                                foreach ($result as $obj) {
                                    ...
                                    <tr class="gradeX">
                                        <td>
                                            <a title="<?php echo $obj->category_name; ?>" href="<?php echo admin_url('entertainmentCat/index/' . $obj->id) ?>"><?php echo $count; ?></a>
                                        </td>
                                        <td>
                                            <a style="color: #000" title="<?php echo $obj->category_name; ?>" href="<?php echo admin_url('entertainmentCat/index/' . $obj->id) ?>"><?php echo $obj->category_name; ?></a>
                                        </td>
                                        <td class="text-center"><?php echo $obj->status == 1 ? 'Active' : 'Inactive'; ?></td>
                                        <td class="text-center">
                                            <a class="btn btn-primary btn-xs" href="<?php echo admin_url('entertainmentCat/index/' . $obj->id) ?>"><i class="icon-pencil"></i></a>
                                            <a class="btn btn-danger btn-xs" onclick="return confirm('Are you Sure??\nYou Want to Delete this item!');" href="<?php echo admin_url('entertainmentCat/delete/' . $obj->id) ?>">
                                    ...
                                    if (is_array($result) && !empty($result)) {
                                        foreach ($result as $obj) {
                                            ...
                                            <tr class="gradeX">
                                                <td>
                                                    <a title="<?php echo $obj->category_name; ?>" href="<?php echo admin_url('entertainmentCat/index/' . $obj->id) ?>"><?php echo $count . '.' . $count1; ?></a>
                                                </td>
                                                <td>
                                                    <a style="margin-left: 20px; color: #777" title="<?php echo $obj->category_name; ?>" href="<?php echo admin_url('entertainmentCat/index/' . $obj->id) ?>">- <?php echo $obj->category_name; ?></a>
                                                </td>
                                                <td class="text-center"><?php echo $obj->status == 1 ? 'Active' : 'Inactive'; ?></td>
                                                <td class="text-center">
                                                    <a class="btn btn-primary btn-xs" href="<?php echo admin_url('entertainmentCat/index/' . $obj->id) ?>"><i class="icon-pencil"></i></a>
